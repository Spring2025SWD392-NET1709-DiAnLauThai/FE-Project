...
import BackImg from "@/public/images/review-picture.jpg";

// Import động để tối ưu hiệu suất
const DesignReviewPage = dynamic(() => import("@/components/desig-review/index"));
const ServiceReviewPage = dynamic(() => import("@/components/service-review/index"));
